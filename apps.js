  ...
  "apps": [
    {
      ...
      "date": "2026-09-26",
      "description": "Calcola i giorni di preavviso dovuti per CCNL e anzianità, l'ultimo giorno di lavoro e la data di decorrenza da mettere nel modulo.",
      ...
      "business": {
        "keyword": "giorni di preavviso dimissioni",
        "keywords": [
          "calcolo preavviso dimissioni",
          "quanti giorni di preavviso devo dare",
          "ultimo giorno di lavoro dimissioni",
          "data decorrenza dimissioni"
        ],
        "intent": "Chi ha già deciso di licenziarsi e deve sapere subito quanti giorni deve, quale sarà il suo ultimo giorno in azienda e che data scrivere nelle dimissioni telematiche.",
        "target": "Lavoratori dipendenti 22-55 anni che cercano dal telefono prima di consegnare la lettera, spesso di sera.",
        "edge": "È l'unico che implementa davvero le regole di decorrenza (dal giorno dopo oppure dal 1° o dal 16 del mese) e i mesi di calendario invece di moltiplicare per 30, mostra il preavviso su un calendario e dà già pronta la data di decorrenza da copiare nel modulo del Ministero, che è l'errore più comune.",
        "monetization": [
          "adsense",
          "pro",
          "support"
        ...
        "pro": [
          ...
          "Confronto tra date di consegna"
        ],
        "affiliate": []
      },
      "size": 55194
    ...
    },
    {
      ...
      "date": "2026-09-21",
      "description": "Calcola la rata del mutuo, gli interessi totali e il piano di ammortamento mese per mese, senza registrarti e senza lasciare i tuoi dati.",
      "category": "finanza-personale",
      "tags": [
        "mutuo",
        "casa",
      ...
      "business": {
        "keyword": "calcolo rata mutuo",
        "keywords": [
          "quanto pago di mutuo al mese",
          "piano di ammortamento mutuo",
          "rata mutuo 150000 euro",
          "quanti interessi pago sul mutuo"
        ],
        "intent": "Chi sta valutando l'acquisto di casa e vuole sapere subito quanto pagherebbe al mese e quanto gli costa davvero il mutuo, prima di parlare con la banca.",
        "target": "Chi compra la prima casa o rinegozia il mutuo, 28-55 anni, quasi sempre da telefono mentre guarda gli annunci immobiliari.",
        "edge": "Nessun modulo, nessun contatto commerciale: rata, interessi totali e piano di ammortamento completo mese per mese, leggibile dal telefono e funzionante offline.",
        "monetization": [
          "adsense",
          "pro",
          "support"
    ...
    },
    {
      ...
      "date": "2026-09-20",
      "description": "Quanto TFR hai accumulato e quanto ti resta dopo le tasse: accantonamenti, rivalutazione ISTAT e tassazione separata anno per anno.",
      "category": "finanza-personale",
      "tags": [
        "tfr",
        "lavoro",
      ...
      "business": {
        "keyword": "calcolo tfr",
        "keywords": [
          "quanto tfr mi spetta",
          "calcolo tfr netto",
          "come si calcola il tfr",
          "tfr quanto si accumula all'anno"
        ],
        "intent": "Chi sta per lasciare il lavoro, o vuole controllare la cifra scritta in busta paga, e cerca subito quanto TFR ha accumulato e quanto ne resta al netto delle tasse.",
        "target": "Lavoratori dipendenti del settore privato, 25-60 anni, spesso da telefono durante o dopo l'orario di lavoro.",
        "edge": "Risultato in due campi, dettaglio anno per anno con rivalutazione e imposta sostitutiva, tassazione separata con detrazione TFR: nessun concorrente mostra tutta la filiera su telefono.",
        "monetization": [
          "adsense",
          "pro",
          "support"
        ...
        "pro": [
          "Dettaglio anno per anno ed export CSV",
          "Simulazione anticipo TFR",
          "Confronto TFR in azienda o fondo pensione"
        ],
        "affiliate": []
      },
      "size": 41760
    },
    {
      ...
      "business": {
        ...
        "edge": "Scrivi partenza e arrivo (qualsiasi comune): percorso stradale reale con km di autostrada, prezzo del carburante della regione aggiornato ogni mattina (open data MIMIT), pedaggio, usura, diviso a persona; senza registrazione. Pro: tappe, auto vs treno, viaggi salvati, PDF.",
        "monetization": [
          "adsense",
          "affiliate",
          "pro",
